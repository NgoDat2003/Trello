export const mockData = {
  board: {
    ...
    columnOrderIds: ['column-id-02', 'column-id-03', 'column-id-01', 'column-id-111'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 boards
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        title: 'To Do Column 01',
        cardOrderIds: ['card-id-06', 'card-id-05', 'card-id-01', 'card-id-04', 'card-id-03', 'card-id-02', 'card-id-07'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
      ...
      },
      {
        _id: 'column-id-111',
        boardId: 'board-id-01',
        title: 'Done Column 111',
        cardOrderIds: ['card-id-placeholder-card'],
        cards: [
          { _id: 'card-id-placeholder-card',
            boardId: 'board-id-01', 
            columnId: 'column-id-111', 
            FE_Placeholder:true
          },
        ]
      }
